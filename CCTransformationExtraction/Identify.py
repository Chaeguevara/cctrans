...
# import allennlp_models.rc  # added
...
def noun_phrases_correct(noun_phrases_list):
    ...
    print("def noun_phrases_correct")
    print(f"noun_phrases_list: {noun_phrases_list}")

    for cur_noun in noun_phrases_list:
        print(f"cur_noun: {cur_noun}")
        if cur_noun in cn:
            print(f"cur_noun in cn: {cur_noun}")
            noun_phrases_CleanList.append(cur_noun)
            print('noun_phrases_CleanList:', noun_phrases_CleanList)
        else:
            print(f"cur_noun not in cn: {cur_noun}")
            cur_p = nt.sent_tokenize(cur_noun)
            print(f"cur_noun not in cn tokenize: {cur_p}")
            tokenized_sen = [nt.word_tokenize(p) for p in cur_p]  # [['nearest', 'supermarket']]
            print(f"tokenized_sen: {tokenized_sen}")
            ...
            print(f"nounStr_Clean: {nounStr_Clean}")

            cur_noun_Clean = ' '.join(text for text in nounStr_Clean).strip()
            print(f"cur_noun_Clean: {cur_noun_Clean}")
            ...
            print(f"cur_noun_Clean: {cur_noun_Clean}")
    print(f"noun_phrases_CleanList: {noun_phrases_CleanList}")
...
def write_trans(coreTypeDict, coreTransType):
    ...
    try:
        ...
        print(f"coreTransType:{coreTransType}")
